          ...
          <div className="signupForm">
            <div className="FormFields">
              <div className="fullName">
                ...
                <input className="w-full p-2 rounded-lg border border-[var(--border)] bg-[var(--background-secondary)] text-[var(--foreground)] focus:outline-none focus:ring-2 focus:ring-[var(--primary)]" type="text" id="fullName" name="fullName" placeholder="please enter your full name" />
              </div>
              ...
              <div className="password mt-4 relative">
                ...
                <input type={isPasswordShown ? "password" : "text"} className='w-full p-2 rounded-lg border border-[var(--border)] bg-[var(--background-secondary)] text-[var(--foreground)] focus:outline-none focus:ring-2 focus:ring-[var(--primary)]' />
              ...
              <div className="submit mt-6">
                <button className="w-full cursor-pointer py-2 rounded-lg bg-[var(--primary)] text-white font-semibold hover:bg-[var(--primary-dark)] transition-colors duration-300">Sign Up</button>
              </div>
