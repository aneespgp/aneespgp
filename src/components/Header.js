...
const Header = () => {
  ...
  const navItems = [
    ...
    { href: "#rapidfire", label: "Rapidfire" },
  ...
  return (
    <header 
      ref={headerRef}
      className={`fixed top-0 left-0 right-0 z-50 glass border-b border-[var(--border)] backdrop-blur-md transition-transform duration-300 ease-in-out ${
